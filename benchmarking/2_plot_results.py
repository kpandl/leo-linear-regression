...
plt.figure(4)
plt.loglog(data_points, constraints, marker='x')
plt.xlabel("Number of data points")
plt.ylabel("Number of constraints")
plt.title("Log-Log plot: Number of constraints vs. number of data points")
plt.savefig("loglog_plot_constraints_vs_data_points.png")

plt.figure(5)
plt.loglog(data_points, runtime, marker='x')
plt.xlabel("Number of data points")
plt.ylabel("Proving time (min)")
plt.title("Log-Log plot: Proving time vs. number of data points")
plt.savefig("loglog_plot_proving_time_vs_data_points.png")

plt.figure(6)
plt.loglog(data_points, max_memory, marker='x')
plt.xlabel("Number of data points")
plt.ylabel("Max memory (GB)")
plt.title("Log-Log plot: Max memory vs. number of data points")
plt.savefig("loglog_plot_max_memory_vs_data_points.png")